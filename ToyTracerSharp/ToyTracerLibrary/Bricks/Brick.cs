            ...
            if (wide == 1 || length == 1)
            {
                ...
                for (int i = 0; i < wide; i++)
                {
                    for (int j = 0; j < length; j++)
                    {
                        ...
                        xsc = 0.5 * 3.0 / 8.0;
                        ysc = 0.5 * 3.0 / 8.0;
                        zsc = 0.5 * (6.0 / 5.0 - 3.0 / 16.0) * (1 + 4 * ToyTracer.EPSILON);
                        if (Rounded)
                        {
            ...
            else
            {
                ...
                for (int i = 0; i < wide; i++)
                {
                    ...
                    for (int j = 0; j < length; j++)
                    {
                        ...
                        xsc = 0.5 * 0.789;
                        ysc = 0.5 * 0.789;
                        zsc = 0.5 * (6.0 / 5.0 - 3.0 / 16.0) * (1 + ToyTracer.EPSILON * 10);
                        if (Rounded)
                        {
                            cyl.Rounded = true;
                            // TODO: rounded bottom only.
                        ...
                        xsc = 0.5 * 5.0 / 8.0;
                        ysc = 0.5 * 5.0 / 8.0;
                        zsc = 0.5 * (6.0 / 5.0 - 3.0 / 16.0) * (1 + ToyTracer.EPSILON * 15);
                        scale.MakeScale(xsc, ysc, zsc);
                        invScale.MakeScale(1 / xsc, 1 / ysc, 1 / zsc);
                        xtrans = 1 + i;
                        ytrans = 1 + j;
